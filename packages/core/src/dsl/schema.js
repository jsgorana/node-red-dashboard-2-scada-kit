/**
 * ajv JSON Schema for the tag-binding DSL.
 * Used by parser.js to validate a binding config before evaluation.
 */
        ...
        properties: {
          ...
          target: {
            ...
            properties: {
              ...
              name: { type: 'string' },   // required for attribute/style/transform targets
              axis: { type: 'string', enum: ['x', 'y'] },  // for level target
              max:  { type: 'number' },
            },
          },
          transform: {
